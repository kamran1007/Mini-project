...
class Window:
    ...
    def Run1(self):
        ...
        # if backtracking is selected
         ...
         https://infytq.onwingspan.com/en/page/lex_auth_01322242888880947https://infytq.onwingspan.com/en/page/lex_auth_0132224288888094723#databaseCourses23#databaseCourses                              cursor="hand2")
